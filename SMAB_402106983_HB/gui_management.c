...
/**
 * This is the file that GUI (gtk libary here) implement for the project occurs:
 * 
 * Its contains the complete GUI implementation including widget creation, screen navigation, and callback functions for user interactions.
 */
 ...
 // Structure to hold references to all GUI widgets
 ...
 typedef struct {
     ...
     GtkWidget *min_price_entry;         
     GtkWidget *max_price_entry;         
     GtkWidget *type_combo;              
     GtkWidget *facilities_entry;       
     GtkWidget *room_tree;              
     GtkWidget *checkin_entry;           
     GtkWidget *checkout_entry;          
     
     // Booking management widgets
     GtkWidget *booking_tree;            
     
     // Admin widgets
     GtkWidget *new_password_entry;      
     GtkWidget *confirm_password_entry; 
     GtkWidget *date_entry;              
     GtkWidget *booking_id_entry;        
     GtkWidget *admin_username_entry;    
     GtkWidget *start_date_entry;        
     GtkWidget *end_date_entry;          
     GtkWidget *admin_bookings_tree;    
     
     // Receipt widgets
     GtkWidget *receipt_view;            
     
     // Profile widgets
     GtkWidget *full_name_entry;        
     GtkWidget *id_entry;               
     GtkWidget *email_entry;            
     GtkWidget *address_entry;          
     GtkWidget *phone_entry_profile;    
     
     // Signup widgets
     GtkWidget *signup_username_entry;  
     GtkWidget *signup_phone_entry;     
     GtkWidget *signup_confirm_phone_entry; 
 } AppWidgets;
 ...
 // Creates a list store for room tree view
 ...
 static GtkListStore* create_room_list_store(void) {
  ...
  // Creates a list store for booking tree view
 ...
 // Creates a list store for admin bookings tree view
 ...
 // Loads rooms into a list store with optional filtering
 ...
 // Loads user bookings into a list store
 ...
 static void load_user_bookings_into_store(GtkListStore *store, const char *username) {
     ...
     while (fgets(line, sizeof(line), file)) {
         ...
         sscanf(line, "%[^:]:%d:%[^:]:%[^:]:%[^:]:%f:%[^:]:%d", file_username, &room_number, booking_date, check_in_date, check_out_date, &total_price,
                 status, &booking_id);
 ...
 // Loads all bookings into a list store with optional filtering
 ...
 static void load_all_bookings_into_store(GtkListStore *store, BookingFilter *filter) {
     ...
     while (fgets(line, sizeof(line), file)) {
         ...
         sscanf(line, "%[^:]:%d:%[^:]:%[^:]:%[^:]:%f:%[^:]:%d", username, &room_number, booking_date, check_in_date, check_out_date, &total_price,  
                status, &booking_id);
 ...
 // Displays a booking receipt in a text buffer
 ...
 // Loads receipt history for a user into a text buffer
 ...
 // Shows a dialog for updating user profile
 ...
 static void update_user_profile_dialog(void) {
     ...
     GtkWidget *dialog = gtk_dialog_new_with_buttons("Update Profile", GTK_WINDOW(window),GTK_DIALOG_MODAL | GTK_DIALOG_DESTROY_WITH_PARENT, 
 ...
 // Callback for customer login button click
...
void on_admin_login_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for back to main menu button click
...
void on_back_to_main_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for customer login form submission
...
void on_customer_login_submit_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for admin login form submission
...
void on_admin_login_submit_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for browse rooms button click

void on_browse_rooms_clicked(GtkWidget *widget, gpointer data) {
    show_room_browse();
}

 // Callback for view bookings button click
...
void on_view_bookings_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for view receipt history button click
...
void on_book_room_clicked(GtkWidget *widget, gpointer data) {
    ...
    if (gtk_tree_selection_get_selected(selection, &model, &iter)) {
        ...
        fprintf(file, "%s:%d:%s:%s:%s:%.2f:%s:%d\n", current_user, room_number, booking_date, formatted_in, formatted_out, price, "active", booking_id); 
 ...
 // Callback for booking cancellation
...
void on_cancel_booking_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for admin password change
...
void on_admin_change_password_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for revenue calculation
...
void on_admin_view_revenue_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for admin booking filtering
...
void on_sign_up_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for sign up form submission
...
void on_sign_up_submit_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for back to login button click
...
void on_back_to_login_clicked(GtkWidget *widget, gpointer data) {
 ...
 // Callback for manage profile button click
...
void show_customer_login() {
 ...
 // Shows the customer menu screen
...
void show_room_browse() {
 ...
 // Shows the booking management screen
...
void show_booking_manage() {
 ...
 // Shows the receipt history screen
...
void show_receipt_history() {
 ...
 // Shows the admin bookings screen
